...
-Grabs AES keys for a specified version of Fortnite.

AESHistory.WriteOldKeysToFile(string version, string path)
-Grabs AES keys for a specified version of Fortnite and writes them to a path of your choice.

AESHistory.GetOldMainKey(string version)
-Attempts to get the main AES key for a specified version of Fortnite.

AESHistory.GetOldKey(string version, string FileName)
-Gets an AES key for a specified Pak file of a chosen Fortnite version.
